...
-- SAD_saida[0]	=>  Location: PIN_127,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[1]	=>  Location: PIN_132,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[2]	=>  Location: PIN_46,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[3]	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[4]	=>  Location: PIN_30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[5]	=>  Location: PIN_49,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[6]	=>  Location: PIN_99,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[7]	=>  Location: PIN_11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[8]	=>  Location: PIN_87,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[9]	=>  Location: PIN_129,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[10]	=>  Location: PIN_28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[11]	=>  Location: PIN_133,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[12]	=>  Location: PIN_50,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SAD_saida[13]	=>  Location: PIN_135,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- end_sad[0]	=>  Location: PIN_142,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- end_sad[1]	=>  Location: PIN_137,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- end_sad[2]	=>  Location: PIN_138,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- end_sad[3]	=>  Location: PIN_141,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- end_sad[4]	=>  Location: PIN_144,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- end_sad[5]	=>  Location: PIN_143,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- read_sad	=>  Location: PIN_128,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- pronto	=>  Location: PIN_7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- sample_can[0]	=>  Location: PIN_126,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_ori[0]	=>  Location: PIN_52,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_can[7]	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_ori[7]	=>  Location: PIN_124,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_can[6]	=>  Location: PIN_100,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_ori[6]	=>  Location: PIN_44,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_can[5]	=>  Location: PIN_125,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_ori[5]	=>  Location: PIN_119,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_can[4]	=>  Location: PIN_51,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sample_ori[4]	=>  Location: PIN_121,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- sample_can[2]	=>  Location: PIN_2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- sample_ori[1]	=>  Location: PIN_53,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \V1|pB|Q[5]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \V1|absto|Add0~2_combout\ = (\V1|absto|Add0~1\ & (\V1|sub|saida[1]~2_combout\ $ ((!\V1|sub|saida[8]~16_combout\)))) # (!\V1|absto|Add0~1\ & ((\V1|sub|saida[1]~2_combout\ $ (\V1|sub|saida[8]~16_combout\)) # (GND)))
-- \V1|absto|Add0~3\ = CARRY((\V1|sub|saida[1]~2_combout\ $ (!\V1|sub|saida[8]~16_combout\)) # (!\V1|absto|Add0~1\))
...
-- pragma translate_on
PORT MAP (
	dataa => \V1|sub|saida[1]~2_combout\,
...
\V1|pB|Q[5]~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \V1|pB|Q[5]~feeder_combout\ = \sample_can[5]~input_o\
...
-- pragma translate_on
PORT MAP (
	datad => \sample_can[5]~input_o\,
	combout => \V1|pB|Q[5]~feeder_combout\);
